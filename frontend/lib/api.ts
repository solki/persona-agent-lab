...
export const api = {
  ...
  archiveRun: (id: number) => request<RunArchiveResponse>(`/runs/${id}/archive`, { method: "POST" }),
  activateRun: (id: number) => request<RunActivateResponse>(`/runs/${id}/activate`, { method: "POST" }),
  hardDeleteRun: (id: number) => request<RunDeleteResponse>(`/runs/${id}/hard-delete`, { method: "DELETE" }),
  deleteRun: (id: number) => request<RunArchiveResponse>(`/runs/${id}`, { method: "DELETE" }),
